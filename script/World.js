...
World = function (game) {
    ...
    var shadowGenerator = new BABYLON.ShadowGenerator(3096, dirLight);
    ...
    var ground3 = BABYLON.Mesh.CreateGround("ground3", SIZE * 2, SIZE * 1.25, 1, scene);
    ground3.position.y = 4;
    ground3.position.z = -SIZE * 1.65 - SIZE * 1.25;
    ground3.material = ground1.material;
    ground3.receiveShadows = true;
    ground3.checkCollisions = true;

    var ground4 = BABYLON.Mesh.CreateGround("ground4", SIZE * 2, SIZE * 1.25, 1, scene);
    ground4.position.y = 6;
    ground4.position.z = -SIZE * 1.65 - 2 * (SIZE * 1.25);
    ground4.material = ground1.material;
    ...
    var littleWall1 = BABYLON.MeshBuilder.CreateBox("lw1", { height: 4.4, width: SIZE * 2, depth: .5 }, scene);
